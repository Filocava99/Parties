package it.forgottenworld.fwparties.party;
...
public class Party implements Serializable {
    ...
    public String getPartyInfo(){
        StringBuilder stringBuilder = new StringBuilder()
                ...
                .append(Bukkit.getServer().getOfflinePlayer(leader).getName())
                .append("\n")
                .append("&6Members list: &a\n");
        for(UUID player : playerList){
            stringBuilder.append(Bukkit.getServer().getOfflinePlayer(player).getName()).append("\n");
        }
